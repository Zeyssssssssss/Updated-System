...
include 'db.php'; // Include your database connection file
    if(isset($_POST['save'])){
        ...
        $sql = "INSERT INTO stocks (`itemid`, `itemname`, `category`, `quantity` )VALUES('$Itemid', '$Itemname', '$category', '$quantity' )";
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="lil">
                ...
                <input type="text" id="Item name" placeholder="item id" name="itemid" onkeyup="filterTable()">
                </div>

            <div class="lol">
            <label for="item ID">Item Name:</label>
                <select id="status" name="itemname" required>
